...
export const mockReviews: Review[] = [
  ...
  { id: "r5", user: "Mohamed Saidi", avatar: "https://randomuser.me/api/portraits/men/22.jpg", rating: 5, comment: "Dr. Ahmed Matsy is an exceptional instructor.", comment_en: "Dr. Ahmed Matsy is an exceptional instructor.", comment_fr: "Dr. Ahmed Matsy est un formateur exceptionnel.", comment_ar: "الدكتور أحمد مايسي مدرب استثنائي.", date: "2024-12-28" },
];
